...
public class XMLdatafromPlace extends XML{
...
//	}
	...
	public XMLdatafromPlace(String path) throws DocumentException {
		super(path);
		this.setId_Name();
//		this.setXY();
	...
	public void setId_Name(){
		for(int i=0;i<this.getRoot().element("net").elements("place").size();i++){					
			this.id.add(((Element)(this.getRoot().element("net").elements("place").get(i))).attributeValue("id"));
			this.x1.add("0");
			this.y1.add("0");
		}
	}
